<?php
function calltitle() {
	echo "Event Title Here";
}
function callsubtitle() {
	echo "Subtitle Here, Add some text so it'll be cool";
}
function callmenu() {
	echo "<ul class='w3-navbar w3-teal'>";
	for($i=1;$i<=5;$i++) {
		echo "<li><a href='#'>Menu".$i."</a></li>";
	}
	echo "</ul>";
}
function callhotmenu() {
	echo "<br>";
	for($o=1;$o<=5;$o++) {
		echo "<div>";
		echo "<div class='w3-container' style='width:20%; float: left;'>";
		echo "<div class='w3-card-8'>";
		echo "<img src='icon.png' alt='Norway' style='width:100%'>";
		echo "<div class='w3-container w3-center'>";
		echo "<p style='font-size: 12px'>Lorem ipsum domet wakwakwaw</p>";
		echo "</div></div>";
		echo "<button class='w3-btn-block w3-white' style='font-size: 11px; color: w3-grey'>Continue #".$o."</button>";
		echo "</div></div></div>";
	}
}
